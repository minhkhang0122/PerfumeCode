...
namespace BanHangMyPham.Areas.Admin.Controllers
{
    [Area("Admin")]
    public class AdminRolesController : Controller
    {
        ...
        public AdminRolesController(PerfumeDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("RolesId,RoleName,Description")] Role role)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RolesId,RoleName,Description")] Role role)
        {
            if (id != role.RolesId)
            {
                return NotFound();
